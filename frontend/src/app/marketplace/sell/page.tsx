        ...
        {(step === "form" || step === "error") && (
          ...
          <div className="flex items-center justify-center gap-1 mt-1">
            <div className="relative group inline-flex items-center gap-1 cursor-help">
              ...
              <span className="font-sans text-xs text-[#aaa]">How does escrow work?</span>
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 bg-[#1a1a1a] border border-[#333] rounded-lg px-3 py-2.5 text-left hidden group-hover:block z-50 shadow-xl">
                <p className="font-sans text-xs text-[#ccc] leading-relaxed">Your USDC is held by a smart contract — not by CryptoBazaar. We cannot move or access your funds at any point.</p>
