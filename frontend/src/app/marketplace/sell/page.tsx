        ...
        {(step === "form" || step === "error") && (
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              <label className="font-sans text-sm font-semibold text-[#333] uppercase tracking-widest">
                Amount (USDC)
              </label>
              <div className="relative group inline-flex shrink-0">
                <a href="/articles/how-escrow-works" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-white border border-[#e5e5e5] shadow-sm hover:border-[#7b3fe4] transition-colors">
                  <Info className="w-3 h-3 text-[#7b3fe4]" />
                </a>
                <div className="absolute bottom-full left-0 mb-2 w-64 bg-white border border-[#e5e5e5] rounded-xl px-3 py-2.5 text-left hidden group-hover:block z-50 shadow-lg">
                  <p className="font-sans text-xs text-[#555] leading-relaxed">Your USDC is held by a smart contract — not by CryptoBazaar. We cannot move or access your funds at any point.</p>
                  <a href="/articles/how-escrow-works" target="_blank" rel="noopener noreferrer" className="font-sans text-xs font-semibold text-[#7b3fe4] mt-1 block">Learn more →</a>
                </div>
              </div>
            </div>
