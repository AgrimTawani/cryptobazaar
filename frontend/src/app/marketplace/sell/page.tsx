        ...
        {(step === "form" || step === "error") && (
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <a href="/articles/how-escrow-works" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-white border border-[#e5e5e5] shadow-sm hover:border-[#7b3fe4] transition-colors shrink-0" title="How does escrow work?">
