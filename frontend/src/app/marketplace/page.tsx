    ...
    <div className="min-h-screen bg-[#f5f5f5]">
      ...
      <header className="bg-white border-b border-[#ebebeb] px-4 md:px-10 h-[64px] flex items-center justify-between gap-2 sticky top-0 z-50">
        ...
        <div className="flex items-center gap-2 md:gap-3 min-w-0">
          <Link href="/" className="hidden md:inline font-sans text-sm text-[#888] no-underline border border-[#e5e5e5] rounded-full px-4 py-1.5 hover:bg-[#f5f5f5] transition-colors">Home</Link>
